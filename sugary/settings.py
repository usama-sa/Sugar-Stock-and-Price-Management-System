...
SECRET_KEY = 'django-insecure-$#m9z1f%lgr44)paxnlhz$%t&_5@t$+0s7a4bifs4ln4vu=1gd'
...
WSGI_APPLICATION = 'sugary.wsgi.application'
...
LOGIN_REDIRECT_URL = 'homepage'                             # sets the login redirect to the 'home' page after login
